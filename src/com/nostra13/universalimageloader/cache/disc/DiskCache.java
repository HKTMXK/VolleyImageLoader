...
public interface DiskCache extends Cache{
     ...
     */
    CacheEntry get(String imageUri);
     ...
     * 
     * @param imageUri Original image URI
     * @param imageStream Input stream of image (shouldn't be closed in this
     *            method)
     * @param listener Listener for saving progress, can be ignored if you don't
     *            use
     ...
     */
//    boolean put(String imageUri, InputStream imageStream, IoUtils.CopyListener listener)
//            throws IOException;
    boolean put(String imageUri, InputStream imageStream, IoUtils.CopyListener listener)
            throws IOException;
