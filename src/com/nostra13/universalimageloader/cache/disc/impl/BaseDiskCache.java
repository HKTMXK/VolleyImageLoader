...
public abstract class BaseDiskCache implements DiskCache {
    ...
    public CacheEntry get(String imageUri) {
        String path = cacheDir + "/" + fileNameGenerator.generate(imageUri);
        if (FileUtil.checkFileExists(path)) {
            File target = getFile(imageUri);
            return new CacheEntry(target);
        }
        return null;
    }
     ...
     */
    // TODO protected testcase need it public
