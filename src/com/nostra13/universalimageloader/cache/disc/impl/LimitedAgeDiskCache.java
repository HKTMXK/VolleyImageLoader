...
public class LimitedAgeDiskCache extends BaseDiskCache {
    ...
    public CacheEntry get(String imageUri) {
        CacheEntry cacheEntry = super.get(imageUri);
        File file = null;
        if (cacheEntry != null) {
            file = (File) cacheEntry.data;
        }
    ...
    public boolean put(String imageUri, InputStream imageStream, IoUtils.CopyListener listener)
            throws IOException {
        boolean saved = super.put(imageUri, imageStream, listener);
        rememberUsage(imageUri);
        return saved;
    }

    @Override
    public boolean put(String imageUri, CacheEntry cacheEntry){
        boolean saved = super.put(imageUri, cacheEntry);
        rememberUsage(imageUri);
        return saved;
    }
